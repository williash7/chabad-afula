...
export function ReportsTab() {
  ...
  const [exportDataTab, setExportDataTab] = useState<'donations' | 'tasks' | 'contacts'>('donations');
  ...
  const switchExportTab = (tab: 'donations' | 'tasks' | 'contacts') => {
    setExportDataTab(tab);
    setManualMode(false);
    setManualSelected(new Set());
  };
