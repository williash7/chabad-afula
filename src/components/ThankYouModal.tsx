...
export function ThankYouModal({ donorName, amount, phone, onClose }: { donorName: string, amount: number, phone: string, onClose: () => void }) {
  ...
  const templates = {
    he: `שלום ${fn},\nרצינו לומר תודה רבה על תרומתך בסך ${amount} ₪! משפחת חב"ד בעלייה מעריכה את התמיכה שלך מאוד. שיעמוד לך ולבני משפחתך לטובה ולברכה מרובה ברוחניות ובגשמיות!`,
    en: `Dear ${fn},\nThank you so much for your generous donation of ₪${amount}! The Chabad BaAliya family deeply appreciates your support. May it bring you and your family abundant blessings both spiritually and materially!`,
    ru: `Здравствуйте ${fn},\nОгромное спасибо за ваше щедрое пожертвование в размере ₪${amount}! Семья Хабад ба-Алия глубоко ценит вашу поддержку. Пусть это принесет вам и вашей семье огромные благословения во всем!`
  };
